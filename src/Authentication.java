...
public class Authentication extends JFrame {
	...
	public Authentication() {
		...
		label.setIcon(new ImageIcon("/images/icons8-customer-16.png"));
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setBounds(382, 188, 31, 19);
		panel.add(lblNewLabel_1);
		lblNewLabel_1.setIcon(new ImageIcon("/images/icons8-key-2-16.png"));
		...
		JLabel lblCopyrightscThedeepanshumourya = new JLabel("Copyrights(c) Shubham Sharma 2018.");
